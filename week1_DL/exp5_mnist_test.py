...
# wandb 사용을 위함
wandb.init(project="mnist", entity="jswfs1284", name='miniSPPF')
...
from common import miniVGG, miniResNet, miniViT, miniBottleneckCSP, miniSPPF
model = miniSPPF().to(device)
#torchsummary.summary(model, (1, 28, 28), batch_size=200)     # 모델 구조 요약
...
# 모델 저장
torch.save(model.state_dict(), ckpt_dir + '/exp5-model.pth')
