...
'''
Object Detection의 경우 객체가 아닌 배경을 보고 판단하는 경우가 있음
'''

# wandb 사용을 위함
wandb.init(project="mnist", entity="jswfs1284")
...
for epoch in range(num_epoch):
    with tqdm(train_loader, total=len(train_loader), unit='batch') as tepoch:
        ...
        for i, (x, y) in enumerate(tepoch):
            ...
            if i == 0 and epoch == num_epoch-1:  # 마지막에만 출력하기
                ...
                (Image.fromarray(_)).save('./heatmap/exp3_heatmap.png', 'png')
...
# 모델 저장
torch.save(model.state_dict(), ckpt_dir + '/exp3-model.pth')
